...
call dein#add('pangloss/vim-javascript')    " JavaScript support
call dein#add('leafgarland/typescript-vim') " TypeScript syntax
call dein#add('maxmellon/vim-jsx-pretty')   " JS and JSX syntax
